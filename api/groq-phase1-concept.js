...
export default async function handler(req, res) {
  ...
  try {
    ...
    const systemPrompt = `あなたは世界最高峰のマーダーミステリー作家です。以下の厳格な品質基準に従って商業作品レベルの高品質なシナリオを生成してください。

【品質基準】
1. 論理的一貫性: 矛盾のない筋書きと証拠
2. 独創性: オリジナルで印象的な設定・トリック  
3. 詳細性: 各要素を具体的かつ詳細に描写
4. 重複回避: 同じ内容の繰り返しを厳禁
5. 推理可能性: プレイヤーが論理的に推理できる構造
6. エンターテイメント性: 面白く魅力的なストーリー
